      ...
      departments: [
        ...
        },
        {
          ...
          employees: [
            ...
            "Артем Бандуков / Ермолаев Дмитрий — Руководитель склада / старший менеджер склада",
        ...
        },
        {
          ...
          icon: "Megaphone",
          employees: [
            "Колмогорова Валерия — Директор отдела маркетинга",
            "Алиса Банова — Опер. директор отдела маркетинга",
            "Анастасия Кайфеджян — Менеджер клиентского сервиса",
            "Яровицкая Евгения — Менеджер оффлайн мероприятий",
            "Гордиенко Диана — Оптовые продажи",
            "Елизарова Юля — Оптовые продажи",
          ],
        },
        {
          name: "Технический отдел / Продукт",
          icon: "Code",
          employees: [
      ...
      departments: [
        {
          ...
          icon: "Stethoscope",
          employees: ["Главный врач", "Врач", "Медсестра"],
        },
        {
          name: "Отдел продаж",
          icon: "ShoppingCart",
          employees: ["Руководитель продаж", "Менеджер", "Менеджер"],
        },
        {
          name: "Склад и доставка",
          icon: "Package",
          employees: ["Заведующий складом", "Кладовщик", "Курьер"],
        },
        {
          name: "Финансы",
          icon: "CreditCard",
          employees: ["Финансовый менеджер", "Бухгалтер"],
        },
      ],
    },
  ],
