      ...
      departments: [
        {
          name: "Отдел продаж",
          icon: "TrendingUp",
          employees: ["Руководитель отдела продаж", "Менеджер по продажам", "Менеджер по продажам"],
        },
        {
          name: "Производство",
          icon: "Settings",
          employees: ["Начальник производства", "Технолог", "Мастер"],
        },
        {
          name: "Логистика",
          icon: "Truck",
          employees: ["Логист", "Кладовщик"],
        },
        {
          name: "Финансы",
          icon: "DollarSign",
          employees: ["Финансовый директор", "Бухгалтер"],
        },
      ],
    },
    {
